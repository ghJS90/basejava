...
//    protected static final File STORAGE_DIR = new File("C:\\testFileStorage");
    ...
    static {
        ...
        R_1.setContact(ContactType.EMAIL, "mail1@ya.ru");
        R_1.setContact(ContactType.PHONE, "11111");
        R_1.setSection(SectionType.OBJECTIVE, new TextSection("Objective1"));
        R_1.setSection(SectionType.PERSONAL, new TextSection("Personal data"));
        R_1.setSection(SectionType.ACHIEVEMENT, new ListSection("Achivment11", "Achivment12", "Achivment13"));
        R_1.setSection(SectionType.QUALIFICATIONS, new ListSection("Java", "SQL", "JavaScript"));
        R_1.setSection(SectionType.EXPERIENCE,
                new OrganizationSection(
                        new Organization("Organization11", "http://Organization11.ru",
                                new Organization.Position(2005, Month.JANUARY, "position1", "content1"),
                                new Organization.Position(2001, Month.MARCH, 2005, Month.JANUARY, "position2", "content2"))));
        R_1.setSection(SectionType.EDUCATION,
                new OrganizationSection(
                        new Organization("Institute", null,
                                new Organization.Position(1996, Month.JANUARY, 2000, Month.DECEMBER, "aspirant", null),
                                new Organization.Position(2001, Month.MARCH, 2005, Month.JANUARY, "student", "IT facultet")),
                        new Organization("Organization12", "http://Organization12.ru")));
        R_2.setContact(ContactType.SKYPE, "skype2");
        R_2.setContact(ContactType.PHONE, "22222");
        R_1.setSection(SectionType.EXPERIENCE,
                new OrganizationSection(
